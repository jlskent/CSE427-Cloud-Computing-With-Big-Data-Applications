...
//
// Debug information:
// Generated date: Wed Nov 07 10:18:32 PST 2018
...
public class accounts extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("acct_num", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        acct_num = (Integer)value;
      }
    });
    setters.put("acct_create_dt", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        acct_create_dt = (java.sql.Timestamp)value;
      }
    });
    setters.put("acct_close_dt", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        acct_close_dt = (java.sql.Timestamp)value;
      }
    });
    ...
    setters.put("created", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        created = (java.sql.Timestamp)value;
      }
    });
    setters.put("modified", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        modified = (java.sql.Timestamp)value;
      }
    });
  }
  public accounts() {
...
this.readFields0(__dataIn);  }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(FieldFormatter.escapeAndEnclose(acct_num==null?"\\N":"" + acct_num, delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(acct_create_dt==null?"\\N":"" + acct_create_dt, delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(acct_close_dt==null?"\\N":"" + acct_close_dt, delimiters));
    __sb.append(fieldDelim);
