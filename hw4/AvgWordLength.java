...
//Use the given Configuration, command-line args to run the given Tool----AvgWordLength.
  ...
  public int run(String[] args) throws Exception {
    ...
    //Specify data types of Mapper output.
    job.setMapOutputKeyClass(Text.class);
    job.setMapOutputValueClass(IntWritable.class);

    //Specify data types of Reducer output.
