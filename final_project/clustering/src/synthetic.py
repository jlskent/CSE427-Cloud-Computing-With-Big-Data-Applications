...
def GreatCircleDistance(p1, p2):
    ...
    # p2[0] lon2
    # p2[1] lat2
    radius = 1  # radius of Earth
    x = (p2[0] - p1[0]) * cos((p2[1] + p1[1]) *0.00872664626)
    y = p2[1] - p1[1]
...
if __name__ == "__main__":
    ...
    print "heihey"
    print Clocations
    Clocations = [(-90.171112059999999, 30.092735650000002), (-75.362937930000001, 39.725557299999998), (-117.9957428, 34.056018379999998), (-112.404335, 33.577716909999999), (-87.176986690000007, 37.014423409999999)]
    ...
    for cluster in clusters:
        ...
        ax1.scatter(npCluster[:,0], npCluster[:,1],s=4,facecolors=colors[color_index],edgecolor='none', marker='o',alpha=0.2)
        color_index = color_index + 1 

    # visualize centroids
    npClocations = np.reshape(Clocations,(-1,2))
    ax1.scatter(npClocations[:,0], npClocations[:,1],s=15,c='black')
    plt.show()
